...
function scjpc_enqueue_pole_members_script(): void {
  wp_enqueue_style('poles-contacts', SCJPC_ASSETS_URL . 'css/pole-contacts.css', false, '1.41');
  wp_enqueue_style('scjpc-global', SCJPC_ASSETS_URL . 'css/global.css', [], '1.01');

  wp_enqueue_script('poles-contacts', SCJPC_ASSETS_URL . 'js/pole-contacts.js', ['jquery'], '1.41');
