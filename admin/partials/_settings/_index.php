...
wp_enqueue_script('admin-settings', SCJPC_ASSETS_URL . 'js/admin-settings.js', ['jquery'], '8.9', true);
wp_enqueue_style('admin-email', SCJPC_ASSETS_URL . 'css/email-multiple.css', [], time(), 'all');
wp_enqueue_script('admin-email', SCJPC_ASSETS_URL . 'js/email-multiple.js', ['jquery'], '1.8', true);
