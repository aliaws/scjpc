...
function load_bootstrap_assets(): void {
  ...
  wp_enqueue_style('frontend_css', SCJPC_ASSETS_URL . 'css/frontend.css', false, '6.9');
  ...
  wp_enqueue_script('frontend_js', SCJPC_ASSETS_URL . 'js/frontend.js', false, '8.84', true);
}
