    ...
    <div class="d-flex b justify-content-end mb-2 align-items-center" role="group">
      <div class="d-flex b justify-content-end mb-2" role="group" aria-label="Basic outlined example">
        <button type="button" id="export_as_excel" data-query="<?php echo $search_result['search_query']; ?>"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="btn-icon bi bi-file-earmark-excel" viewBox="0 0 16 16">
        ...
        <button type="button" id="export_as_csv" data-query="<?php echo $search_result['search_query']; ?>"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="btn-icon bi bi-filetype-csv" viewBox="0 0 16 16">
