    ...
    <div class="card custom-card p-2">
        <form class="needs-validation" id="jpa_search" method="post" novalidate>
            <div class="mb-3">
                ...
                <input type="text" name="jpa_number_visible" id="jpa_number_visible" value="<?php echo $_REQUEST['jpa_number'] ?? ''; ?>" required autofocus/>
                ...
                <?php
                //this line is important to admin jpa-edit funcnality
